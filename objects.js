...
function personName() {
  ...
  console.log(person['firstName']); // Code here
}
personName()
...
//Code here
const favoriteThings = { band: "backsteetboys", food: "pizza", person: "Sally", book: "The Beatles", movie: "The Godfather", holiday: "Christmas"}
...
/*
  ...
  Return the updated object.
*/
const obj1 = {value1: 3, value2: 5, value7: 8}
...
const obj2 = {username: "hello", password: "asdkhwej", website: "google.com"}
/*
...
const obj3 = {username: "hello", password: "asdkhwej", website: "google.com"}
...
const obj4 = {username: "hello", password: "asdkhwej", website: "google.com"}
function copyObject(obj4) {
  // REPLACE THIS WITH YOUR CODE
  let newObj = {...obj4}
  newObj.copy = true
  console.log(newObj)
...
// REPLACE THIS WITH YOUR CODE
let zooAnimalCount = {lion: 5, tiger: 10, bear: 9}

function zooAnimals(zooAnimalCount){
  const {lion, tiger, bear} = zooAnimalCount
  let total = lion + tiger + bear
  console.log(total)
}
zooAnimals(zooAnimalCount)
